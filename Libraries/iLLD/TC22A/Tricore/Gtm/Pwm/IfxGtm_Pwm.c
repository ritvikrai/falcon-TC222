...
IFX_STATIC void IfxGtm_Pwm_updateGlobalControlUnitData(IfxGtm_Pwm *pwm)
{
    ...
    if (IFXGTM_PWM_GET_TGC_INDEX(firstChannel) != IFXGTM_PWM_GET_TGC_INDEX(lastChannel))
    {
        ...
        pwm->globalControl.upenMask0     = (uint32)(IFXGTM_PWM_CHANNELS_MASK(firstChannel, (uint32)IfxGtm_Pwm_SubModule_Ch_7) << (uint32)IFX_GTM_TOM_TGC0_GLB_CTRL_UPEN_CTRL0_OFF);
        pwm->globalControl.upenMask1     = (uint32)(IFXGTM_PWM_CHANNELS_MASK(IfxGtm_Pwm_SubModule_Ch_8, lastChannel) << (uint32)IFX_GTM_TOM_TGC0_GLB_CTRL_UPEN_CTRL0_OFF);
    ...
    {
        pwm->globalControl.upenMask0 = (uint32)(IFXGTM_PWM_CHANNELS_MASK(firstChannel, lastChannel) << (uint32)IFX_GTM_TOM_TGC0_GLB_CTRL_UPEN_CTRL0_OFF);
